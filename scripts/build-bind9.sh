...
# HOTRowex + Masstree engines for load-names: C++ shims compiled separately
# below and linked into load-names.
cp "$REPO/src/load_names_hotrowex.cpp" "$REPO/src/load_names_masstree.cpp" "$DEST/"
